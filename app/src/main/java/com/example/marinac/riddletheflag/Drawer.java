        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                ...
                public boolean onMarkerClick(final Marker marker) {
                    ...
                    loca.setLongitude(marker.getPosition().longitude);
                    loca.setLatitude(marker.getPosition().latitude);
                    ...
                    locationManager = (LocationManager) getSystemService(Context.LOCATION_SERVICE);
                    Criteria criteria = new Criteria();
                    if (ActivityCompat.checkSelfPermission(Drawer.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(Drawer.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    //float dist = currentLocation.distanceTo(loca);
                    Log.d("dist", String.valueOf(distance[0]));
